...
public class NewsViewModel extends ViewModel implements MainModelListener {
    ...
    public void getNewsFromCategory(int position) {
        mIsLoad.postValue(true);
        switch (position) {
            case 0:
                mModel.getNewsFrom(Consts.Category.all);
                break;
            case 1:
                mModel.getNewsFrom(Consts.Category.fsk);
                break;
            case 2:
                mModel.getNewsFrom(Consts.Category.sdk);
                break;
            case 3:
                mModel.getNewsFrom(Consts.Category.ry);
                break;
        }
